...
import sampleconnector1.connector.RequestStream;
...
public class HttpRequest implements HttpServletRequest{
     ...
     * parameter information is requested via one of the <code>getParameter()</code>
     * family of method calls. The key is the parameter name, while the value is a String
     * array of values for this parameter.
     * <strong>IMPLEMENTATION NOTE</strong> - Once the parameters for a particular request
     * are parsed and stored here, they are not modified. Therefore, application level access
     * to the parameters need not be synchronized.
     */
    ...
    /**
     * The ServletInputStream that has been returned by <code>getInputString()/code>
     *     if any.
     */
    ...
    protected void parseParameters(){
        ...
        if(StringUtils.equals("POST", getMethod()) && (getContentLength() > 0)
